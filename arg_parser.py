...
def parse_args():
    ...
    parser.add_argument("--model_path", type=pathlib.Path, help="Path to model file")
    ...
    parser.add_argument("-o", "--output_file", type=pathlib.Path, default="./solutions.pkl", help="Name of output file")
