...
class NCI1(InMemoryDataset):
    url = "https://ls11-www.cs.tu-dortmund.de/people/morris/graphkerneldatasets/NCI1.zip"
    ...
    def __init__(self, root, mode="testing", transform=None, pre_transform=None, pre_filter=None):
        ...
        self.url = {"https://ls11-www.cs.tu-dortmund.de/people/morris/graphkerneldatasets/NCI1.zip"}
